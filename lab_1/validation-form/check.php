<?php
    ...
    $mysql1 = new mysqli('localhost', 'root', 'root', 'lab-1'); //Подключаемся к базе данных lab-1
    ...
    //Зарегистрировать
    $mysql = new mysqli('localhost', 'root', 'root', 'lab-1'); //Подключаемся к базе данных lab-1
    ...
    header('Location: /lab_1/login.php'); // Переадресация на ту же страницу
    ?>
